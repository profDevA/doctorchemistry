...
class Rokanthemes_Revolutionslideshow_Block_Adminhtml_Rokanthemerevolution_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('rokanthemerevolutionGrid');
  ...
  {
      $collection = Mage::getModel('revolutionslideshow/rokanthemerevolution')->getCollection();
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('link', array(
          'header'    => Mage::helper('revolutionslideshow')->__('Link'),
          'align'     =>'left',
          'index'     => 'link',
      ));
	  ...
	  $this->addColumn('image', array(
          ...
          'align'     =>'left',
          'index'     => 'image',
		  'renderer' => 'revolutionslideshow/adminhtml_rokanthemerevolution_grid_renderer_image'
      ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('rokanthemerevolution');
